...
data = pd.read_excel("fake_bills.xlsx")
...
def main():
    ...
    if choice == "Home":
        ...
        st.markdown(""" This App is going to classify whether the bills are Fake or Genuine. This Classification is done by
        ...
        margin_low = st.sidebar.slider('Margin Low:', min_value=2.00, max_value=6.90, value=2.00)
        ...
        st.subheader("About")
        st.success("Built by Krishnaveni")
